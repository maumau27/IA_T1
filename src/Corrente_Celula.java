...
public class Corrente_Celula{
		...
		public Corrente_Celula(Celula celula_atual, Corrente_Celula celula_pai, double heuristica, double custo_encontro){
			this.celula_atual = celula_atual;
			this.celula_pai = celula_pai;
			this.custo_acumulado = celula_pai.custo_acumulado + ((celula_atual.custo > 0) ? celula_atual.custo : custo_encontro) ;
